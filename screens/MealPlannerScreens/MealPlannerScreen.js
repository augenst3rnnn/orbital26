...
export default function MealPlannerScreen({ navigation }) {
  ...
  const handleRemoveMeal = (mealType, mealTitle) => {
    ...
    Alert.alert("Remove Meal", `Remove "${mealTitle}" from ${mealType}?`, [
  ...
  return (
    <View className="flex-1 bg-white">
      {/* yellow header */}
      <View className="bg-yellow-200 pt-20 pb-20 px-7">
        <Text className="text-3xl font-bold pt-10 text-gray-800">
          Meal Planner
        </Text>
      ...
      <View className="flex-1 bg-white rounded-t-[40px] px-6 pt-6 -mt-10">
        ...
        >
          ...
          <View className="px-4 pt-2 pb-8 bg-gray-50">
            ...
            {/* breakfast */}
            <Text className="text-md font-bold text-gray-400 mt-4 mb-2 tracking-wider">
              Breakfast
            </Text>
            <MealCard
                ...
                if (dayMeals.breakfast) {
                  navigation.navigate("RecipeDetails", {
                    recipe: {
                      ...
                      extendedIngredients:
                        dayMeals.breakfast.extendedIngredients || [],
                    },
                  });
                }
              }}
              ...
              onRemove={() =>
                handleRemoveMeal("Breakfast", dayMeals.breakfast?.title)
              }
              isPast={isPast}
            />

            {/* lunch */}
            <Text className="text-md font-bold text-gray-400 mt-2 mb-2 tracking-wider">
              Lunch
            </Text>
            <MealCard
              meal={dayMeals.lunch}
                ...
                if (dayMeals.lunch) {
                  navigation.navigate("RecipeDetails", {
                    recipe: {
                      ...
                      extendedIngredients:
                        dayMeals.lunch.extendedIngredients || [],
                    },
                  });
                }
              }}
            ...
            <MealCard
                ...
                if (dayMeals.dinner) {
                  navigation.navigate("RecipeDetails", {
                    recipe: {
                      ...
                      extendedIngredients:
                        dayMeals.dinner.extendedIngredients || [],
                    },
                  });
                }
              }}
              ...
              onRemove={() =>
                handleRemoveMeal("Dinner", dayMeals.dinner?.title)
              }
              isPast={isPast}
            />
            ...
            {/* week at a glance */}
            <View className="mt-5">
              <Text className="text-md font-semibold text-gray-400 mb-3 tracking-wider">
                Week at a glance
              </Text>
