...
export default function MealPlannerScreen({ navigation }) {
  ...
  return (
    <View className="flex-1 bg-white">
      <View className="bg-yellow-200 pt-16 pb-16 px-7">
        <Text className="text-3xl font-bold pt-6 text-gray-800">
          Meal Planner
        </Text>
      ...
      <ScrollView
        className="flex-1 bg-white rounded-t-[30px] -mt-5"
        refreshControl={
      ...
      >
        ...
        {/* day content */}
        <View className="px-6 pt-2 pb-8 bg-gray-50">
          {/* date label */}
