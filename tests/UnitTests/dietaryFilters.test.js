...
describe('Dietary Preference Filters', () => {
  ...
  describe('Vegetarian Filter', () => {
    ...
    it('allows recipes with no meat', () => {
      const recipe = createTestRecipe('Vegetable Soup', ['carrots', 'onions', 'potatoes']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['vegetarian']
  ...
  describe('Vegan Filter', () => {
    ...
    it('allows recipes with only plant-based ingredients', () => {
      const recipe = createTestRecipe('Vegan Chili', ['beans', 'tomatoes', 'onions']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['vegan']
  ...
  describe('Dairy-Free Filter', () => {
    it('filters out recipes with milk', () => {
      const recipe = createTestRecipe('Mac and Cheese', ['pasta', 'milk', 'cheese']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['dairyFree']
    ...
    it('allows recipes without dairy', () => {
      const recipe = createTestRecipe('Grilled Salmon', ['salmon', 'lemon', 'herbs']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['dairyFree']
  ...
  describe('Gluten-Free Filter', () => {
    ...
    it('allows recipes without gluten', () => {
      const recipe = createTestRecipe('Rice Bowl', ['rice', 'chicken', 'vegetables']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['glutenFree']
  ...
  describe('Halal Filter', () => {
    ...
    it('allows recipes without pork, alcohol, or gelatin', () => {
      const recipe = createTestRecipe('Chicken Rice', ['chicken', 'rice', 'vegetables']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['halal']
  ...
  describe('Paleo Filter', () => {
    ...
    it('allows recipes with paleo-friendly ingredients', () => {
      const recipe = createTestRecipe('Grilled Salmon', ['salmon', 'vegetables']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['paleo']
  ...
  describe('Multiple Dietary Preferences', () => {
    it('filters out recipe that does not meet all preferences', () => {
      const recipe = createTestRecipe('Chicken Cheese Pasta', ['chicken', 'pasta', 'cheese']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['halal', 'dairyFree']
    ...
    it('allows recipe that meets all preferences', () => {
      const recipe = createTestRecipe('Grilled Chicken', ['chicken', 'rice', 'vegetables']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
        ['halal', 'dairyFree']
    ...
    it('allows recipe when all preferences pass (vegetarian + dairyFree)', () => {
      const recipe = createTestRecipe('Vegetable Stir Fry', ['vegetables', 'tofu', 'rice']);
      const result = matchesDietaryPreferences(
        recipe.title,
        recipe.ingredients,
